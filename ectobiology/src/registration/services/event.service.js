...
export class eventService {
    ...
    static resourceEndpoint =environment.events_url;
     ...
     */
    static async getAll() {
        return httpInstance.get(eventService.resourceEndpoint);
    }
    ...
    static async getById(id) {
        return httpInstance.get(`${this.baseApiUrl}${this.resourceEndpoint}/${id}`);
    }
